 ...
 */
public class PlayerHandshakeEvent extends Event implements Cancellable { // todo: Farsi Kardan In Evente PlayerHandshakeEvent
    ...
    private String failMessage = "Age Dari Server Bungee Mizani, Bayad IP-Forwarding Ham To Config On Koni!"; // FeatherMC
